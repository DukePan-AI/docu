    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            height: "44px",
            padding: isOpen ? "0 8px 0 12px" : "0 8px",
            background: "linear-gradient(180deg, rgba(255,255,255,0.32) 0%, rgba(255,255,255,0) 100%)",
            borderBottom: "1px solid rgba(30, 90, 168, 0.08)",
          }}
        >
          <div className="flex items-center gap-2 mr-auto">
            <div
              className="flex items-center justify-center rounded-md px-1.5 py-1 border"
              style={{
            ...
            {isOpen && (
              <span className="text-[11px] font-semibold tracking-[0.14em] uppercase" style={{ color: "var(--color-text-muted)" }}>
                Finder
              </span>
            )}
          </div>
          ...
          <>
            ...
            >
              <div
                ...
                style={{ color: "var(--color-sidebar-muted)" }}
              >
                <p className="text-[10.5px] whitespace-nowrap">Bosch Korea</p>
                <p className="text-[10.5px] whitespace-nowrap">BD/SLP-AOK6</p>
                <p className="text-[10.5px] whitespace-nowrap">개발자 반창훈</p>
              </div>
            </div>
          </>
        )}
