...
import { FinderBrandMark } from "../ui/FinderBrandMark";
  ...
  return (
    ...
    >
      ...
      <button
        ...
        title="홈으로"
      >
        <FinderBrandMark size={28} className="shrink-0" subtle />
        <h1
          className="ts-md font-bold leading-none text-display"
          style={{ color: "var(--color-text-primary)", letterSpacing: "-0.03em" }}
        >
          Finder<span style={{ color: "var(--color-accent)", fontWeight: 800 }}>.</span>
        </h1>
        {hasQuery && (
